                    ...
                    <section className="tfg-disclaimer-section">
                        ...
                        <p>
                            <strong>
                                ...
                                un Trabajo de Fin de Grado (TFG) universitario.
                            </strong>{' '}
                            La plataforma se encuentra en evolución constante y se ofrece sin
                            fines comerciales y “tal cual”, con el objetivo de explorar el
                            bienestar emocional, la escritura personal y la organización de
